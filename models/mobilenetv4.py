...
class MobileNetV4(nn.Module):
    def __init__(self, block_specs, num_classes=2):
        ...
        hidden_channels =  64 # 1280 来自djy的改动，把1280->64
...
def mobilenetv4_conv_tiny(n_classes, **kwargs):
    """
    ...
    block_specs = [
        ...
        ('conv_bn', 1, 1, 24),
        # 14px
        ('uib', 5, 5, 2, 48, 2.0),  # ExtraDW
        # ('uib', 0, 3, 1, 48, 2.0),  # IB
        # ('uib', 0, 3, 1, 48, 2.0),  # IB
        # ('uib', 0, 3, 1, 48, 2.0),  # IB
        # ('uib', 0, 3, 1, 48, 2.0),  # IB
        # ('uib', 3, 0, 1, 48, 2.0),  # ConvNext
        # 7px
        ('uib', 3, 3, 2, 64, 2.0),  # ExtraDW
        # ('uib', 5, 5, 1, 64, 2.0),  # ExtraDW
        # ('uib', 0, 5, 1, 64, 2.0),  # IB
        # ('uib', 0, 5, 1, 64, 2.0),  # IB
        # ('uib', 0, 3, 1, 64, 2.0),  # IB
        # ('uib', 0, 3, 1, 64, 2.0),  # IB
        # ('conv_bn', 1, 1, 480),  # Conv
    ]
    return MobileNetV4(block_specs, n_classes)
